        ...
        <form id="myform">
            <div class="form-group">
                <table>
                    ...
                    <tr>
                        <th align="right"><font face=tahoma>Note</font></th>
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                $.each(res, function(i, v) {
                    ...
                    td = td + `<td><button id="btn-table-search-` + i +
                        `" class="btn-table-search btn btn-sm round btn-info" type="button">Load</button></td>`
                    td = td + `<td><button id="btn-table-delete-` + i +
                        `" class="btn-table-delete btn btn-sm round btn-danger" type="button">Delete</button></td>`
                    row = row + `<tr>` + td + `</tr>`;
                    td = "";
                });
