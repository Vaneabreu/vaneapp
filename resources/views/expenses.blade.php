...
<html lang="{{ str_replace('_','-', app()->getLocale()) }}">
    ...
    @include('partials.nav')  
       <form id="myform">
            ...
            <table>
                    ...
                    <tr>
                        <th align="right"><font face=tahoma>Customer_last_name </font></th>
                        <td> <input type="text" id="customer_last_name" name="customer_last_name" value=""/> </td>
                    </tr>
    ...
    <script>
        $(document).ready(function(){
            ...
            $(document).on("click", ".btn-table-search", function(e){
                   // var table = $(this).closest("table");
                    ...
                    $.ajax({
                url  : "/vanessaapp/public/api/expenses/"+id,
                type : "GET",
                dataType : "json",
                cache: false,
                global: false,
            ...
            $("#btn-save").on("click", function(e){
                ...
                $.ajax({
                    url  : "/vanessaapp/public/api/expenses",
                    type : "POST",
                    dataType : "json",
                    data : formData,
                    processData: false,
        ...
        function loadGrid2()//Funcion para la tabla 
        {
            ...
            $.ajax({
                            url  : "/vanessaapp/public/api/expenses-filter-all",
                            type : "POST",
                            dataType : "json",
                            data : formData,
                            processData: false,
