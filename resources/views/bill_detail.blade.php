    ...
    @include('partials.nav')
       <form id="myform">
          ...
          <table>
                    ...
                    <tr>
                        <th align="right"> <font face=tahoma>Item_name </font></th>
                        <td> <input type="text" id="item_name" name="item_name" value=""/> </td>
                        
                    </tr>

                    <tr>
                        <th align="right"><font face=tahoma>Quantity </font> </th>
                        <td> <input type="text" id="quantity" name="quantity" value=""/> </td>

                    </tr>

                    <tr>
                        <th align="right"><font face=tahoma>Price </font></th>
                ...
                success :  function(res)
                {
                    ...
                    $.each(v, function(ix, vx){
                        ...
                        if (ix == "quantity"){
                          ...
                          td = td + `<td style="color:#FF0CBD">`+vx+`</td>`;
                          }
                          else {
